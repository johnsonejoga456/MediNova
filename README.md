...
A comprehensive, full-stack healthcare management system built with **Next.js, **TypeScript**, **Prisma**, and **Supabase**. This application provides complete patient, doctor, appointment, billing, and laboratory management with role-based access control.
